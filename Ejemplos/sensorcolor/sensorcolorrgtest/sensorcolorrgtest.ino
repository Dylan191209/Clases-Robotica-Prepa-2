/*
Este si puede servirles para mas ejemplo, ya que solo usa un led.
*/
...
void loop() {
  ...
  if ( rojo <= 35 && verde >= 70 && azul >= 60){		// si valores dentro del rango
    Serial.println("ROJO");				// muestra texto
    digitalWrite(lr, HIGH);
  } 
    else if ( verde <= 40 && rojo >= 40 && azul <= 80){	// si valores dentro del rango
